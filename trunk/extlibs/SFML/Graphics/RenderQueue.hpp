...
public :
    ...
    // SCISSOR Test (by Lokk)
    void    SetScissor(bool activated, const Vector2f& origin = Vector2f(0,0), const Vector2f& size = Vector2f(0,0));
...
private :
    ...
    // MODIFIED by Lokk -> Handling scissor test
    Vector2f                myScissorOrigin;
    Vector2f                myScissorSize;
    bool                    myScissorState;
};
